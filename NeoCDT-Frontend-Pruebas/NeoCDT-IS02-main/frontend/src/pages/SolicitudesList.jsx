...
import { getSolicitudes, createSolicitud, deleteSolicitud, updateSolicitud } from "../api/solicitudService.js";
                            ...
                            <div key={solicitud.id} className="solicitud-card" onClick={() => navigate(`/solicitudes/${solicitud.id}`)}>
                                ...
                                <div className="solicitud-details">
                                    <div className="detail-row">
                                        ...
                                        <span className="detail-value">{solicitud.plazo} días</span>
                                    </div>
                                    <div className="detail-row">
                                    ...
                                    {solicitud.tasa && (
                                        <div className="detail-row">
                                            ...
                                            <span className="detail-value">{solicitud.tasa}% EA</span>
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className="solicitud-actions" onClick={(e) => e.stopPropagation()}>
                                    ...
                                    <button
                                        className="btn-edit"
                                        onClick={() => navigate(`/solicitudes/edit/${solicitud.id}`)}
                                        disabled={!esBorrador}
                                        title={!esBorrador ? "Solo se pueden editar solicitudes en Borrador" : "Editar solicitud"}
                                    >
                                        ✏️ Editar
                                    </button>
                                    ...
                                    <button
                                        ...
                                        disabled={!esBorrador}
                                        title={!esBorrador ? "Solo se pueden eliminar solicitudes en Borrador" : "Eliminar solicitud"}
                                    >
                                        🗑️ Eliminar
                                    </button>
                                </div>
