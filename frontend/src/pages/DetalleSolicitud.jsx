    ...
    >
      ...
      <div style={{ marginBottom: "2rem" }}>
        ...
        >
          ...
          <span
            className={`estado-badge ${getEstadoBadgeClass(solicitud.estado)}`}
          >
            {solicitud.estado}
          </span>
        </div>
      ...
      {rendimiento && (
        ...
        >
          ...
          >
            ℹ️ Cálculo basado en tasa efectiva anual de {solicitud.tasa}%
            aplicada durante {solicitud.plazo} días.
          </div>
        </div>
      )}
        ...
        >
            ...
            style={{
              ...
              background:
                solicitud.estado === "Borrador"
                  ...
                  : "var(--gray-200)",
              color:
                solicitud.estado === "Borrador" ? "white" : "var(--gray-600)",
              borderRadius: "var(--radius-md)",
              fontWeight: "600",
            }}
          >
          ...
          <div
            style={{
              padding: "1rem 1.5rem",
              background:
                solicitud.estado === "En validación"
                  ? "var(--primary)"
                  : "var(--gray-200)",
              color:
                solicitud.estado === "En validación"
            ...
            style={{
              ...
              background: ["Aprobada", "Rechazada"].includes(solicitud.estado)
                ? solicitud.estado === "Aprobada"
                  ...
                  : "var(--error)"
                : "var(--gray-200)",
              color: ["Aprobada", "Rechazada"].includes(solicitud.estado)
                ? "white"
                : "var(--gray-600)",
              borderRadius: "var(--radius-md)",
              fontWeight: "600",
      ...
      >
        ...
        >
          ...
          {!esBorrador && (
            ...
            >
              ℹ️ Esta solicitud no puede ser modificada porque está en estado "
              {solicitud.estado}"
            </div>
          )}
        </div>
